...
## Load the data
These data are from: Gaeta J., G. Sass, S. Carpenter. 2012. Biocomplexity at North Temperate Lakes LTER: Coordinated Field Studies: Large Mouth Bass Growth 2006. Environmental Data Initiative.  [link](https://portal.edi repository.org/nis/mapbrowse?scope=knb-lter-ntl&identifier=267)  
```{r}
...
```{r}
mammals_new<-rename(mammals,genus="Genus", afr="AFR", litters_year="litters/year",max_life="max. life",wean_mass="wean mass", litter_size="litter size")
```
